	...
	$.ajax({
		...
		success:function(result){
			if(result.status==0){
				...
				console.log("刷新时的当前页面:" + model.page);
				model.reSelectOrderInfoView(orderList,model.page);
...
//刷新显示订单信息
model.reSelectOrderInfoView = function(orderList,page){
...
//		console.log(tr.data("orderIndex"));
		$('#tbody').append(tr);
		$('#tbody tr:odd').addClass("highlighting");
	}
